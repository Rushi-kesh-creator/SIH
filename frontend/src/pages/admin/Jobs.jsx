...
const ADMIN_JOBS_CACHE_KEY = 'admin_jobs'

export default function AdminJobs() {
  const [jobs, setJobs] = useState(() => {
    try {
      const cached = sessionStorage.getItem(
        ADMIN_JOBS_CACHE_KEY
      )
  ...
  const [loading, setLoading] = useState(() => {
    try {
      return !sessionStorage.getItem(ADMIN_JOBS_CACHE_KEY)
    } catch {
      return true
    }
  })
          ...
          <div className="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted small mb-0">
                Search and monitor job opportunities.
              </p>
            </div>
            ...
            <div className="col-12 col-lg-6">
              ...
              <div className="input-group">
                ...
                <input
                  ...
                  placeholder="Search title, company, location, salary or skills..."
                  value={search}
